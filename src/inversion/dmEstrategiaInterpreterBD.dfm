inherited EstrategiaInterpreterBD: TEstrategiaInterpreterBD
  object qEstrategia: TIBQuery
    Database = BD.IBDatabaseUsuario
    Transaction = BD.IBTransactionUsuario
    SQL.Strings = (
      'select ESTRATEGIA_APERTURA, ESTRATEGIA_CIERRE,'
      ' ESTRATEGIA_APERTURA_POSICIONADO, ESTRATEGIA_CIERRE_POSICIONADO'
      ' from ESTRATEGIA'
